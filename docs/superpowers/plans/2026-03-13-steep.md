# steep Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build a Rust CLI tool (`steep`) that orchestrates mkosi, systemd-ukify, and igvm-tools to produce confidential VM images for AMD SEV-SNP.
...
**Spec:** `docs/superpowers/specs/2026-03-13-steep-design.md`
...
| `src/manifest.rs` | steep manifest schema and generation |
...
- [x]**Step 3: Create minimal main.rs**
...
Run: `cargo build`
Expected: Compiles successfully, binary at `target/debug/steep`
...
git commit -m "feat: initialize steep Rust project with clap skeleton"
```
...
- [x]**Step 2: Add test dependencies to Cargo.toml**
...
- [x]**Step 4: Implement full CLI argument parsing**
...
- [x]**Step 1: Create command module stubs**
...
- [x]**Step 2: Create infrastructure module stubs**
...
- [x]**Step 3: Add `which` and `anyhow` to Cargo.toml**
...
- [x]**Step 4: Wire up main.rs with tracing and command dispatch**
...
- [x]**Step 1: Write tool discovery tests**
...
- [x]**Step 3: Create lib.rs to expose public API for tests**
...
- [x]**Step 4: Implement tool helpers**
...
- [x]**Step 1: Write igvm-tools argument construction tests**
...
- [x]**Step 3: Implement igvm-tools invocation**
...
- [x]**Step 1: Write UKI argument construction tests**
...
- [x]**Step 3: Implement UKI build module**
...
- [x]**Step 4: Add `uki` module to lib.rs**
...
- [x]**Step 1: Write manifest serialization tests**
...
- [x]**Step 4: Add hex dependency to Cargo.toml**
...
- [x]**Step 1: Write mkosi config generation tests**
...
- [x]**Step 3: Implement mkosi config generation**
...
- [x]**Step 1: Implement input validation for cloud-init subcommand**
...
- [x]**Step 1: Implement disk composition stub**
...
- [x]**Step 2: Wire up the full pipeline in cloud_init.rs**
...
- [x]**Step 1: Implement base subcommand with validation and mkosi invocation stub**
...
- [x]**Step 2: Implement kernel subcommand with validation stub**
...
- [x]**Step 3: Update container subcommand**
...
- [x]**Step 4: Verify everything compiles and tests pass**
...
- [x]**Step 1: Add integration test for cloud-init with missing inputs**
